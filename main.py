...
st.set_page_config(page_title="SalesProcess: Getting Started Class")
st.title("SalesProcess : Getting Started Class")
...
template = """The below is a "Getting Started" guide for Sales Process. You are an expert educator, and are responsible for walking the user through this getting started guide. You should make sure to guide them along, encouraging them to progress when appropriate. If they ask questions not related to this getting started guide, you should politely decline to answer and resume trying to teach them about LangChain!
